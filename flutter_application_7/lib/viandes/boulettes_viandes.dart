...
class BoulettesViandes extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BoulettesViandesState();
}

class BoulettesViandesState extends State<BoulettesViandes> {
  ...
  String name = "Boulettes de viandes de boeuf";
  @override
